...
const About = () => {
  return (
    // about page when clicking the read more 
    <div className='container flex  flex-col mx-auto'>
        <h1 className='my-6 text-center justify-center font-bold text-2xl'>About Chai-Otic</h1>
        <p className='text-center'> Chai-Otic is a crowdfunding platform designed for creators to fund their projects with the support of their fans. It&apos;s a space where your fans can directly contribute to your creative endeavors by buying you a chai. Unlock the potential of your fanbase and bring your projects to life.</p>
      <div className="work my-5">
        <h1 className='font-bold text-lg '>How it Works</h1>
       
<div className="box flex gap-6 p-8"> 
        <div className="fan flex gap-2 my-4 w-1/2">
          <img className='rounded-full w-16 h-16 md:block'src="/coll.gif" alt="" width={66} height={66}/>

        <div className="text font-medium">
          <h1> fans contribution</h1>
          <p> your ideas can take you fly on your own dream</p>

        </div>
        </div>

        <div className="coin flex gap-2 my-4 w-1/2">
          <img className='rounded-full  w-16 h-16 md:block'src="/gif.gif" alt="" width={66} height={66}/>

        <div className="text font-medium">
          <h1> Support through chai </h1>
          <p>Every single support matters </p>
